...
#     it 'nick_name,email,password,password_confirmation,first_name_kanji,last_name_kanji,first_name_kana,last_name_kana,birthdayがあれば登録できる' do
#       expect(@user).to be_valid
#     end
...
#     end
#     it '全角文字を含むパスワードでは登録できない' do
#       @user.password = 'aaaaa０'
#       @user.password_confirmation = 'aaaaa０'
#       @user.valid?
#       expect(@user.errors.full_messages).to include
#     end
#     it '重複したemailが存在する場合登録できない' do
